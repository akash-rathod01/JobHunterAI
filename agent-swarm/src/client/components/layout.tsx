...
export const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-background/30 backdrop-blur-xl shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <Sheet open={navOpen} onOpenChange={setNavOpen}>
            ...
            <SheetContent side="left" className="w-64 flex flex-col">
              <SheetHeader>
                <SheetTitle>J-JobHunterAI</SheetTitle>
              </SheetHeader>
                ...
                <div className="mt-auto pt-6 pb-2">
                  <TooltipProvider>
                    <div className="flex flex-col items-start gap-2">
                      <a
                        href="https://github.com/DaKheera47/j-jobhunter-ai/releases"
                        target="_blank"
...
export const ListPanel: React.FC<ListPanelProps> = ({
  ...
  className,
    ...
    <div
      className={cn(
        "min-w-0 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_0_15px_rgba(0,255,180,0.05)] flex flex-col",
        className,
      )}
    >
    {header && (
...
export const DetailPanel: React.FC<DetailPanelProps> = ({
  ...
  <div
    className={cn(
      "min-w-0 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_0_15px_rgba(0,255,180,0.05)] p-4",
...
export const SectionCard: React.FC<SectionCardProps> = ({
  ...
  <section
    className={cn(
      "rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_0_15px_rgba(0,255,180,0.05)] p-4 hover:shadow-[0_0_20px_rgba(0,255,180,0.1)] transition-all",
      className,
    )}
  >
    {children}
