...
import { parseSearchTerms } from "j-jobhunter-ai-shared/utils/search-terms";
import {
  toNumberOrNull,
  toStringOrNull,
} from "j-jobhunter-ai-shared/utils/type-conversion";
  ...
  try {
    const response = await fetch(url, {
      headers: {
        ...
        "User-Agent": "j-jobhunter-ai-hiringcafe-extractor/1.0",
      },
